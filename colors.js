...
var color1 = {r: 56, g: 79, b: 132};

console.log(rgbToLab(color1));
...
function RGBtoXYZ(rgb) {
	...
	g = parseFloat(g / 255);
	b = parseFloat(b / 255);
	r = (r > 0.04045 ? ((r + 0.055) / 1.055) ** 2.4 : r / 12.92) * 100;
	g = (g > 0.04045 ? ((g + 0.055) / 1.055) ** 2.4 : g / 12.92) * 100;
	b = (b > 0.04045 ? ((b + 0.055) / 1.055) ** 2.4 : b / 12.92) * 100;
